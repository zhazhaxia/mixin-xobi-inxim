...
function(e) {
    ...
    try {
        ...
        function() {
            ...
            function str(e, t) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep) for (n = rep.length, r = 0; r < n; r += 1)"string" == typeof rep[r] && (s = rep[r], a = str(s, d), a && i.push(quote(s) + (gap ? ": ": ":") + a));
                    else for (s in d) Object.prototype.hasOwnProperty.call(d, s) && (a = str(s, d), a && i.push(quote(s) + (gap ? ": ": ":") + a));
                    return a = 0 === i.length ? "{}": gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + o + "}": "{" + i.join(",") + "}",
                    gap = o,
                    a
                }
        ...
        function() {
            ...
            c = _.each = function(e, t, r) {
                ...
                if (i && e.forEach === i) e.forEach(t, r);
                    ...
                    for (var s = 0,
                    a = e.length; s < a; s++) if (s in e && t.call(r, e[s], s, e) === d) return ! 1
            ...
            _.throttle = function(e, t, r) {
                ...
                return function() {
                    ...
                    return s = this,
                    a = arguments,
                    u <= 0 || u > t ? (i && (clearTimeout(i), i = null), o = c, n = e.apply(s, a), i || (s = a = null)) : i || r.trailing === !1 || (i = setTimeout(d, u)),
                    n
                }
            },
            _.hashCode = function(e) {
                ...
                for (var s = 0; s < e.length; s++) r = e.charCodeAt(s),
                t = (t << 5) - t + r,
                t &= t;
                return t
            },
            ...
            _.utf8Encode = function(e) {
                ...
                for (t = r = 0, n = e.length, s = 0; s < n; s++) {
                    ...
                    null !== o && (r > t && (a += e.substring(t, r)), a += o, t = r = s + 1)
                }
                return r > t && (a += e.substring(t, e.length)),
                a
            },
            _.base64Encode = function(e) {
                if ("function" == typeof btoa) return btoa(encodeURIComponent(e).replace(/%([0-9A-F]{2})/g,
                function(e, t) {
                ...
                i = d >> 6 & 63,
                o = 63 & d,
                f[p++] = c.charAt(a) + c.charAt(n) + c.charAt(i) + c.charAt(o);
                while (u < e.length);
            ...
            _.UUID = function() {
                ...
                r = function(e) {
                    ...
                    n = [],
                    i = 0;
                    for (r = 0; r < a.length; r++) s = a.charCodeAt(r),
                    n.unshift(255 & s),
                    n.length >= 4 && (i = t(i, n), n = []);
            ...
            _.addEvent = function() {
                ...
                var r = function(r, s, a) {
                    ...
                    if (_.isObject(sd.para.heatmap) && "undefined" == typeof sd.para.heatmap.useCapture && "click" === s && (n = !0), r && r.addEventListener) r.addEventListener(s,
                    function(t) {
            ...
            _.getURLSearchParams = function(e) {
                ...
                r = {},
                s = e.substring(1), a = s.split("&"), n = 0; n < a.length; n++) {
                    var i = a[n].indexOf("=");
                    if (i !== -1) {
            ...
            _.trackLink = function(e, t, r) {
                ...
                r = r || {},
                !(!a || "object" != typeof a) && (!a.href || /^javascript/.test(a.href) || a.target || a.download || a.onclick ? (sd.track(t, r), !1) : (e.event && s(e.event), void(e.ele && _.addEvent(e.ele, "click",
                function(e) {
                    s(e)
                }))))
            },
        ...
        sd.initPara = function(e) {
            ...
            sd.para_default.preset_properties, t, sd.para.preset_properties || {});
            var s;
            ...
            _.localStorage.isSupport() && _.isSupportCors() && "object" == typeof localStorage ? sd.para.batch_send === !0 ? (sd.para.batch_send = _.extend({},
        ...
        var commonWays = {
            ...
            setPlugin: function(e) {
                return !! _.isObject(e) && void _.each(e,
                function(e, t) {
        ...
        sd.getPresetProperties = function() {
            ...
            r = _.extend({},
            _.info.properties(), sd.store.getProps(), e(), t);
        ...
        sd.detectMode = function() {
            function e() {
                ...
                sd._q && _.isArray(sd._q) && sd._q.length > 0 && _.each(sd._q,
                function(e) {
            ...
            s = function(e) {
                function t() {
                    ...
                    _.isObject(sd.para.app_js_bridge) || (e.push(sd.debug.defineMode("2")), r.verify_success = !1),
        ...
        BatchSend.prototype = {
            ...
            sendPrepare: function(e) {
                ...
                else for (var a = 0; a * r < s; a++) this.send({
        ...
        sendState.getSendCall = function(e, t, r) {
            ...
            !sd.para.app_js_bridge && sd.para.batch_send && localStorage.length < 200 ? (sd.log(s), sd.batchSend.add(this.requestData.data), !1) : (sd.bridge.dataSend(s, this, r), void sd.log(s))
        },
        ...
        saEvent.send = function(e, t) {
            ...
            sd.addPropsHook(r),
            sd.para.debug_mode === !0 ? (sd.log(r), this.debugPath(JSON.stringify(r), t)) : sd.sendState.getSendCall(r, s, t)
        },
        ...
        var store = sd.store = {
            ...
            setProps: function(e, t) {
                var r = {};
                r = t ? e: _.extend(this._state.props || {},
                e);
            ...
            clearAllProps: function(e) {
                ...
                _.isArray(e) && e.length > 0) for (var t = 0; t < e.length; t++) _.isString(e[t]) && e[t].indexOf("latest_") === -1 && e[t] in this._state.props && delete this._state.props[e[t]];
        ...
        saNewUser = {
            ...
            checkIsFirstLatest: function() {
                ...
                function(t, r) {
                    ...
                    if (r = r.slice(7), t) {
                        if ("utm" !== r && "url\u89e3\u6790\u5931\u8d25" === e) a["$latest_" + r] = "url\u7684domain\u89e3\u6790\u5931\u8d25";
        ...
        sd.bridge = {
            ...
            initPara: function() {
                ...
                e, sd.para.app_js_bridge) : sd.para.use_app_track === !0 || sd.para.app_js_bridge === !0 || "only" === sd.para.use_app_track ? (sd.para.use_app_track_is_send !== !1 && "only" !== sd.para.use_app_track || (e.is_send = !1), sd.para.app_js_bridge = _.extend({},
            ...
            app_js_bridge_v1: function() {
                ...
                sd.getAppStatus = function(e) {
                    return r(),
                    t(),
                    e ? void(null === s ? a = e: (e(s), s = null)) : s
                }
            }
        };
        var heatmap = sd.heatmap = {
            ...
            initHeatmap: function() {
                ...
                function(t) {
                    ...
                    else if ("button" === n.tagName.toLowerCase() || "a" === n.tagName.toLowerCase()) e.start(r, n, s.parentNode.tagName.toLowerCase());
